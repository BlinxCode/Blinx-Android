package com.android.blinxapp.ui.feature.presentation.components.common
...
fun outlineColors(): TextFieldColors {
    val colorStr =  if (isSystemInDarkTheme()){
        OutlinedTextFieldDefaults.colors(
            ...
            focusedContainerColor = containerColorBlack,
            unfocusedContainerColor = containerColorBlack,
            disabledContainerColor = containerColorBlack,
            errorContainerColor = Color.Transparent,
            cursorColor = Color.White,
            selectionColors = LocalTextSelectionColors.current,
            focusedBorderColor = primaryGreen,
            unfocusedBorderColor = containerColorBlack,
