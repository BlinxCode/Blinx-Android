...
fun LoginScreen(navController: NavController) {
    ...
    Column(
        ...
        if (emailErrorState.value) {
            Text(text = "Required", color = androidx.compose.ui.graphics.Color.Red)
        }
        Spacer(Modifier.size(16.dp))
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
            TextButton(onClick = {
                ...
                Text(text = "Register ?", color = androidx.compose.ui.graphics.Color.Red)
            }
        }
    }
}
...
fun RegistrationScreen(navController: NavController) {
    ...
    Column(
        ...
        Button(
            ...
            content = {
                Text(text = "Register", color = androidx.compose.ui.graphics.Color.White)
            },
            modifier = Modifier.fillMaxWidth(),
            colors = ButtonDefaults.buttonColors(containerColor = androidx.compose.ui.graphics.Color.Red)
        )
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
            TextButton(onClick = {
                ...
                Text(text = "Login", color = androidx.compose.ui.graphics.Color.Red)
            }
        }
    }
}